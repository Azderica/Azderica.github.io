...
그렇기 때문에 어떤 문제를 접근할 때 나의 방식은, 미리미리 작업을 하는 것이다. 꾸준하게 여러 작업을 진행하는 방식과, 집중하는 문제를 정의하는 방식을 처리한다. 여러 작업을 건드리는 것이 여러 일을 벌리는 작업은 다른 의미다. 그리고 일을 접근할 때, 하나의 피처단위로 작업을 마무리하는 것을 목표로 잡는다. 그러나 쉽지는 않다. 열심히 해야지...

<br/>

## 어떻게 더 나아갈 수 있을까?

다른 사람들과 함께 같이 가는 것이 중요하다. 